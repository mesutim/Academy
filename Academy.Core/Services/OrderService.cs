...
namespace Academy.Core.Services
{
    public class OrderService : IOrderService
    {
        ...
        public bool FinalyOrder(string userName, int orderId)
        {
            ...
            if (_userService.BalanceUserTransaction(userName) >= order.OrderSum)
            {
                order.IsFinaly = true;
                _userService.AddTransaction(new Transaction()
                {
                ...
                {
                    _context.UserCourseMap.Add(new UserCourse()
                    {
        ...
        public bool IsUserInCourse(string userName, int courseId)
        {
            ...
            return _context.UserCourseMap.Any(c => c.UserId == userId && c.CourseId == courseId);
        }
